...
public class BbsDAO {
	...
	public ArrayList<BbsDTO> getList(int pageNumber) {	//	게시물을 출력하는 함수
	...
	public ArrayList<BbsDTO> getList (String search, int pageNumber) { // 검색과 관련된 글을 출력하는 함수
		...
		try {
			...
			// TODO Auto-generated catch block
			System.err.println("BBS getList2 SQLException error");
			returns = "error";
		} finally {
			if (pstmt != null)
				try {
