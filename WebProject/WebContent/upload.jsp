	...
	<section class="container">
		<form enctype="multipart/form-data" method="post" action="./uploadAction.jsp">
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				<thead>
					<tr>
						<th colspan="1" style="backgroud-color: #eeeeee; text-align: center;">사진파일 업로드</th>
					</tr>
				</thead>
				<tbody>
					<tr>	
						<td><textarea class="form-control" placeholder="사진과 같이 올릴 내용 (100자 제한)" name="fileContent" maxlength="100" style="height: 350px;"></textarea></td>
					</tr>
					<tr>
			...
			<div class="d-flex bd-highlight mb-3">
				...
				<div class="p-2 bd-highlight">
					<!-- uploadAction으로 작성한 게시글 전송 -->
					<input type="submit" class="btn btn-primary mr-sm-2" value="업로드">
				</div>
			</div>
		</form>
	</section>
